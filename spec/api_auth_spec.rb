...
describe 'InoreaderApi::Api auth' do
  ...
  it 'should auth failed (unAuthorizing)' do
    ...
    proc {
      InoreaderApi::Api.new(:username => 'fail', :password => 'pass')
  ...
  it 'should auth failed 500' do
    ...
    proc {
      InoreaderApi::Api.new(:username => 'error', :password => 'pass')
  ...
  it 'should to timeout' do
    ...
    proc {
      InoreaderApi::Api.new(:username => 'timeout_name', :password => 'fail_pass')
